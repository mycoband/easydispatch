...
- Walkthrough capture: when AI Job Walkthrough is on (tech Work + office job), Record video walkthrough is the hero CTA (“Film + narrate — AI writes the report”); More capture options (voice/photo/library) stays collapsed until expanded — same on mobile and desktop. Tech Extra photos stays secondary/collapsed.
